...
class TestCreateErrorResponse:
    ...
    def test_error_response_with_code(self):
        ...
        result = create_error_response(
            "Auth failed", code=ErrorCode.AUTHENTICATION_FAILED
        )
...
class TestCreateConfigurationError:
    ...
    def test_configuration_error_custom_reason(self):
        ...
        result = create_configuration_error(
            "JENKINS_URL", reason="is not a valid URL"
        )
        assert result == {
...
class TestCreateApiError:
    ...
    def test_api_error_with_status_code(self):
        ...
        result = create_api_error(
            "Jenkins", "Build not found", status_code=404
        )
        assert result == {
            "error": "Jenkins API error: Build not found",
            "error_code": "API_ERROR",
            "details": {"service": "Jenkins", "reason": "Build not found", "status_code": 404},
        }
    ...
    def test_api_error_with_500_status(self):
        ...
        assert result == {
            ...
            "error_code": "API_ERROR",
            "details": {"service": "Azure", "reason": "Internal server error", "status_code": 500},
        }
...
class TestWrapException:
    ...
    def test_wrap_exception_with_complex_exception(self):
        ...
        assert result == {
            ...
            "error_code": "INTERNAL_ERROR",
            "details": {"exception_type": "RuntimeError", "exception_message": "Database connection failed"},
        }
    ...
    def test_wrap_exception_with_custom_exception(self):
        ...
        assert result == {
            ...
            "error_code": "INTERNAL_ERROR",
            "details": {"exception_type": "CustomError", "exception_message": "Custom error message"},
        }
